  ...
  en: {
    ...
    form: {
      ...
      errors: {
        ...
        firstNameInvalid: 'First name: letters only, 2–30 characters (as on Aadhaar)',
        firstNameTooLong: 'First name: maximum {max} characters',
        lastNameRequired: 'Last name is required',
        lastNameInvalid: 'Last name: letters only, 2–30 characters (as on Aadhaar)',
        lastNameTooLong: 'Last name: maximum {max} characters',
        ...
        houseNoInvalid: 'House no.: letters, numbers, and . , / # ( ) - only',
        houseNoTooLong: 'House no.: maximum {max} characters',
        streetRequired: 'Street/ road is required',
        streetInvalid: 'Street: letters, numbers, and . , / # ( ) - only',
        streetTooLong: 'Street: maximum {max} characters',
        areaRequired: 'Area / locality is required',
        areaInvalid: 'Area: letters, numbers, and . , / # ( ) - only',
        areaTooLong: 'Area: maximum {max} characters',
        postOfficeRequired: 'Post office is required',
        postOfficeInvalid: 'Post office: letters, spaces, dot, or hyphen only',
        postOfficeTooLong: 'Post office: maximum {max} characters',
        countryRequired: 'Please select country',
        stateRequired: 'Please select state',
        stateInvalid: 'State: letters, spaces, dot, or hyphen only',
        stateTooLong: 'State: maximum {max} characters',
        districtRequired: 'District is required',
        districtInvalid: 'District: letters, spaces, dot, or hyphen only',
        districtTooLong: 'District: maximum {max} characters',
        townInvalid: 'Town: letters, spaces, dot, or hyphen only',
        townTooLong: 'Town: maximum {max} characters',
        ...
        rehbarInvalid: 'Rahbar: letters only, 2–40 characters (as on Aadhaar)',
        rehbarTooLong: 'Rahbar: maximum {max} characters',
        careOfInvalid: 'Care of: letters only, 2–35 characters',
        careOfTooLong: 'Care of: maximum {max} characters',
        landmarkInvalid: 'Landmark: letters, numbers, and . , / # ( ) - only',
        landmarkTooLong: 'Landmark: maximum {max} characters',
        fieldTooLong: 'Maximum {max} characters allowed',
    ...
    payment: {
      ...
      upiHelp: {
        ...
        mobile:
          'On a phone: choose UPI, then tap PhonePe, Google Pay, or Paytm. The app opens for PIN — after paying, return to this browser tab (do not close it). We confirm payment automatically.',
        note:
          'Manual UPI ID entry is no longer available on most devices (NPCI rules from Feb 2026). Use QR on desktop or your UPI app on mobile. Autopay mandates also use the same PhonePe / GPay / Paytm app flow.'
      },
      errors: {
    ...
    admin: {
      ...
      booksSummary: {
        ...
        combinedTotals: 'All counters — combined totals',
        briefIntroSold: 'Brief Introduction sold: {count}',
        bothParichay: 'Both Sankshipt Parichay + Brief Introduction: {count}',
      ...
      inventory: {
        ...
        allCounters: 'All counters',
        search: 'Search book',
        searchPlaceholder: 'Book name or S.No.',
        lowStockFilter: 'Stock level',
        ...
        add: 'Add',
        addPlaceholder: 'Qty',
        addStockCol: 'Add stock',
        addHint: 'Type the number of books received and click Add to increase this counter\u2019s stock.',
        overviewHint: 'Overview of all counters. Select a single counter above to add stock to books.',
        none: 'No inventory data. Apply the inventory SQL and seed stock to get started.',
        ...
        direction: 'Direction',
        amount: 'Quantity',
        stockIn: 'Stock in (add)',
        stockOut: 'Stock out (remove)',
        note: 'Note',
      ...
      subscriptionsSummary: {
        ...
        allSubscribers: 'All — {count} subscribers',
        subscribersLabel: 'Subscribers',
        copiesLabel: 'Publication copies',
        publication: 'Publication',
        copies: 'Copies',
        quantity: 'Quantity',
        totalSales: 'Total sales',
        grandTotal: 'Grand total',
        grandTotalCopies: 'Grand total (copies)',
        combinedTotals: 'All durations — combined totals',
        countsHint:
          '{subscribers} subscribers in this month — {copies} publication copies total (one subscriber can take Hindi, English, and/or Spiritual Bliss).',
        oneYear: '1 year',
        fiveYear: '5 year',
        sectionTitle: 'Anand Sandesh — Publications',
        downloadPdf: 'Download summary PDF',
        none: 'No subscriptions found for the selected month and filters.',
        hindi: 'Anand Sandesh (Hindi)',
        english: 'Anand Sandesh (English)',
        spiritualBliss: 'Spiritual Bliss (English)'
      },
      users: {
  ...
  hi: {
    ...
    form: {
      ...
      errors: {
        ...
        firstNameInvalid: 'पहला नाम: केवल अक्षर, 2–30 अक्षर (आधार कार्ड जैसा)',
        firstNameTooLong: 'पहला नाम: अधिकतम {max} अक्षर',
        lastNameRequired: 'उपनाम आवश्यक है',
        lastNameInvalid: 'उपनाम: केवल अक्षर, 2–30 अक्षर (आधार कार्ड जैसा)',
        lastNameTooLong: 'उपनाम: अधिकतम {max} अक्षर',
        ...
        houseNoInvalid: 'मकान नं.: अक्षर, अंक और . , / # ( ) - ही',
        houseNoTooLong: 'मकान नं.: अधिकतम {max} अक्षर',
        streetRequired: 'गली/ सड़क आवश्यक है',
        streetInvalid: 'गली/ सड़क: अक्षर, अंक और . , / # ( ) - ही',
        streetTooLong: 'गली/ सड़क: अधिकतम {max} अक्षर',
        areaRequired: 'क्षेत्र / इलाका आवश्यक है',
        areaInvalid: 'क्षेत्र: अक्षर, अंक और . , / # ( ) - ही',
        areaTooLong: 'क्षेत्र: अधिकतम {max} अक्षर',
        postOfficeRequired: 'डाकघर आवश्यक है',
        postOfficeInvalid: 'डाकघर: केवल अक्षर, रिक्ति, बिंदु या हाइफ़न',
        postOfficeTooLong: 'डाकघर: अधिकतम {max} अक्षर',
        countryRequired: 'कृपया देश चुनें',
        stateRequired: 'कृपया राज्य चुनें',
        stateInvalid: 'राज्य: केवल अक्षर, रिक्ति, बिंदु या हाइफ़न',
        stateTooLong: 'राज्य: अधिकतम {max} अक्षर',
        districtRequired: 'ज़िला आवश्यक है',
        districtInvalid: 'ज़िला: केवल अक्षर, रिक्ति, बिंदु या हाइफ़न',
        districtTooLong: 'ज़िला: अधिकतम {max} अक्षर',
        townInvalid: 'कस्बा/ शहर: केवल अक्षर, रिक्ति, बिंदु या हाइफ़न',
        townTooLong: 'कस्बा/ शहर: अधिकतम {max} अक्षर',
        pinRequired: 'पिन कोड आवश्यक है',
        pinInvalid: 'एक मान्य पिन कोड दर्ज करें',
        genderRequired: 'लिंग चुनें',
        rehbarRequired: 'रहबर आवश्यक है',
        rehbarInvalid: 'रहबर: केवल अक्षर, 2–40 अक्षर (आधार कार्ड जैसा)',
        rehbarTooLong: 'रहबर: अधिकतम {max} अक्षर',
        careOfInvalid: 'के द्वारा: केवल अक्षर, 2–35 अक्षर',
        careOfTooLong: 'के द्वारा: अधिकतम {max} अक्षर',
        landmarkInvalid: 'निशान: अक्षर, अंक और . , / # ( ) - ही',
        landmarkTooLong: 'निशान: अधिकतम {max} अक्षर',
        fieldTooLong: 'अधिकतम {max} अक्षर',
    ...
    payment: {
      ...
      upiHelp: {
        ...
        mobile:
          'फ़ोन पर: UPI चुनें, फिर PhonePe, Google Pay या Paytm टैप करें। ऐप PIN के लिए खुलता है — भुगतान के बाद इस ब्राउज़र टैब पर वापस आएँ (बंद न करें)। हम भुगतान स्वतः पुष्ट करते हैं।',
        note:
          'अधिकांश उपकरणों पर मैन्युअल UPI ID दर्ज अब उपलब्ध नहीं है (फ़रवरी 2026 से NPCI नियम)। डेस्कटॉप पर QR या मोबाइल पर UPI ऐप का उपयोग करें। Autopay में भी PhonePe / GPay / Paytm ऐप वाला वही प्रवाह है।'
      },
      errors: {
    ...
    admin: {
      ...
      booksSummary: {
        ...
        tabSummary: 'सारांश',
        counter: 'काउंटर',
        allCounters: 'सभी काउंटर',
        bookName: 'पुस्तक का नाम',
        quantity: 'मात्रा',
        totalSales: 'कुल बिक्री',
        grandTotal: 'कुल योग',
        combinedTotals: 'सभी काउंटर — संयुक्त योग',
        briefIntroSold: 'Brief Introduction बिकी: {count}',
        bothParichay: 'संक्षिप्त परिचय + Brief Introduction दोनों: {count}',
        downloadPdf: 'सारांश PDF डाउनलोड',
      ...
      inventory: {
        ...
        allCounters: 'सभी काउंटर',
        search: 'पुस्तक खोजें',
        searchPlaceholder: 'पुस्तक का नाम या क्र.सं.',
        lowStockFilter: 'स्टॉक स्तर',
        ...
        add: 'जोड़ें',
        addPlaceholder: 'मात्रा',
        addStockCol: 'स्टॉक जोड़ें',
        addHint: 'प्राप्त पुस्तकों की संख्या दर्ज करें और इस काउंटर का स्टॉक बढ़ाने के लिए जोड़ें पर क्लिक करें।',
        overviewHint: 'सभी काउंटरों का अवलोकन। पुस्तकों में स्टॉक जोड़ने के लिए ऊपर एक काउंटर चुनें।',
        none: 'कोई इन्वेंटरी डेटा नहीं। इन्वेंटरी SQL लागू करें और स्टॉक सीड करें।',
        noBooks: 'चयनित फ़िल्टर से कोई पुस्तक मेल नहीं खाती।',
        statusLabels: {
          ok: 'स्टॉक में',
          low: 'कम',
          out: 'स्टॉक समाप्त'
        ...
        quantity: 'मात्रा',
        saveSet: 'स्टॉक सहेजें',
        adjustStock: 'स्टॉक समायोजित करें',
        direction: 'दिशा',
        amount: 'मात्रा',
        stockIn: 'स्टॉक जोड़ें',
        stockOut: 'स्टॉक घटाएँ',
        note: 'टिप्पणी',
        notePlaceholder: 'कारण (वैकल्पिक)',
        applyAdjust: 'समायोजन लागू करें',
        saving: 'सहेजा जा रहा है...',
        ...
        balance: 'शेष',
        reason: 'कारण',
        noHistory: 'अभी तक कोई स्टॉक गतिविधि नहीं।',
        reasons: {
          set: 'सेट',
          stock_in: 'स्टॉक जोड़ा',
          stock_out: 'स्टॉक घटाया',
          sale: 'बिक्री'
        },
        errors: {
          amount: 'शून्य से अधिक मात्रा दर्ज करें।'
        },
        toasts: {
          saved: 'इन्वेंटरी अपडेट हुई।',
          error: 'इन्वेंटरी अपडेट नहीं हो सकी।'
        }
      },
      subscriptionsSummary: {
        tabList: 'सदस्य',
        ...
        allSubscribers: 'सभी — {count} सदस्य',
        subscribersLabel: 'सदस्य',
        copiesLabel: 'प्रकाशन प्रति',
        publication: 'प्रकाशन',
        copies: 'प्रति',
        quantity: 'मात्रा',
        totalSales: 'कुल बिक्री',
        grandTotal: 'कुल योग',
        grandTotalCopies: 'कुल योग (प्रति)',
        combinedTotals: 'सभी अवधि — संयुक्त योग',
        countsHint:
          'इस महीने {subscribers} सदस्य — कुल {copies} प्रकाशन प्रति (एक सदस्य हिंदी, अंग्रेज़ी और/या स्पिरिचुअल ब्लिस ले सकता है)।',
        oneYear: '1 वर्ष',
        fiveYear: '5 वर्ष',
        sectionTitle: 'आनंद संदेश — प्रकाशन',
        downloadPdf: 'सारांश PDF डाउनलोड',
        none: 'चयनित महीने और फ़िल्टर के लिए कोई सदस्यता नहीं मिली।',
        hindi: 'आनंद संदेश (हिंदी)',
        english: 'आनंद संदेश (अंग्रेज़ी)',
        spiritualBliss: 'स्पिरिचुअल ब्लिस (अंग्रेज़ी)'
      },
      users: {
