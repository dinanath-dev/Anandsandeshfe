...
export const translations = {
  en: {
    ...
    auth: {
      ...
      otpSentToast:
        'Verification code sent. Check your inbox — and your spam or junk folder if you do not see it.',
    ...
    profile: {
      ...
      changeEmailHelp: 'A verification code will be sent to your new email address. Your login email updates only after OTP verification.',
    ...
    form: {
      ...
      publicationsOptional: 'Optional — choose Anand Sandesh, Spiritual Bliss, or both',
      publicationsPriceNote:
        'Price is per publication — selecting both doubles the amount automatically.',
  ...
  hi: {
    ...
    auth: {
      ...
      otpSentToast:
        'सत्यापन कोड भेज दिया गया है। इनबॉक्स देखें — न दिखे तो स्पैम या जंक फ़ोल्डर भी जाँचें।',
    ...
    profile: {
      ...
      changeEmailHelp: 'आपके नए ईमेल पर सत्यापन कोड भेजा जाएगा। OTP सत्यापन के बाद ही लॉगिन ईमेल बदलेगा।',
    ...
    form: {
      ...
      publicationsOptional: 'वैकल्पिक — आनंद संदेश, स्पिरिचुअल ब्लिस, या दोनों चुनें',
      publicationsPriceNote:
        'मूल्य प्रति प्रकाशन है — दोनों चुनने पर राशि स्वतः दोगुनी हो जाती है।',
